...
CREATE TABLE `operacoes` (
  ...
  `operacao` varchar(200) DEFAULT 'NÃO SE APLICA',
  `contadebitoid` int DEFAULT '-1',
  `codigo` varchar(200) DEFAULT '00000000',
  `contacreditoid` int DEFAULT '-1',
...
INSERT INTO `operacoes` VALUES (1,'ALTERAÇÃO CONTA',NULL,'00000000',1,200),(2,'DEPOSITO',-1,'00000000',1,200);
...
-- Dump completed on 2021-01-09 20:50:42
